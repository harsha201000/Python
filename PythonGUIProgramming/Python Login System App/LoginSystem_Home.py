...
# Step 3: Add an image to the window
image_path = 'user.png'  # Replace with the actual path to your image file
img = tk.PhotoImage(file=image_path)
image_label = tk.Label(parent, image=img)
image_label.pack()

# Step 4: Create and place the username label and entry
username_label = tk.Label(parent, text="Username:", fg="blue")
username_label.pack()
username_entry = tk.Entry(parent, bg="lightgrey", fg="black")
username_entry.pack()

# Step 5: Create and place the password label and entry
...
# Step 7: Create and place the login button and define a function to validate the login
login_button = tk.Button(parent, text="Login", command=validate_login, bg="green", fg="white")
login_button.pack()

# Step 8: Start the tkinter window event loop
parent.mainloop()
