#Space War by Harsha Malipeddi/ Python 3.11.4
...
class Missile(Sprite):
    ...
    def fire(self):
        if self.status == "ready":
            #Play Missile sound
            winsound.PlaySound("SpaceLaserShot PE1095407.wav",winsound.SND_ASYNC)
...
#ally = Ally("square", "lightgreen", 0, 0)
...
allies = []
for i in range(6):
    allies.append(Ally("square", "lightgreen", -100, 0))
...
while True:
    ...
    for enemy in enemies:
        ...
        if player.is_collision(enemy):
            ...
            winsound.PlaySound("mi_explosion_03_hpx.wav",winsound.SND_ASYNC)
