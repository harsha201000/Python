# Golf Game in Python 3
# C:\Users\Harsha\python-workpace\Golf\golf.py
...
# Create an iconphoto for your display
golf_game = pygame.image.load("golf_game.png")
pygame.display.set_icon(golf_game)
            ...
            # Ball is still on screen so move ball closer to final_ball_position 
                ...
                if ball_distance == 0:
                    ...
                    # Ball missed hole 
                        ...
                        # Reset slider at bottom of meter 220 
                        shot_power = 1 
                        slider_direction = 'up' 
                        slider_timer = SLOW_SLIDER_SPEED
